...
Experimenting with more diverse data augmentation techniques.
Increasing the number of training epochs.
Training a larger YOLOv11 model (e.g., yolo11m.pt) if computational resources permit.
Evaluating the model on a wider range of real-world, unseen images to test generalization.

References & Acknowledgements
Dataset: Construction Site Safety Dataset by Roboflow Universe Projects.
Reference Notebooks:
YOLOv8 Finetuning for PPE detection by HinePo.
Ultralytics YOLO11 Notebook by Glenn Jocher.
detection using yolov11 by Myriam Gam62.
